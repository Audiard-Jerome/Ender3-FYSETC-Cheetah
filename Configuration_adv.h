 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN         // PB0 → ventilateur de hotend
...
#define PID_AUTOTUNE_MENU_SAVE

#define FILAMENT_LOAD_UNLOAD_GCODES
#define FILAMENT_LOAD_PURGE_LENGTH 50
#define FILAMENT_LOAD_PURGE_FEEDRATE 3
...
/********************************************
 * 🕹️ LCD – Infos + Marlin Games + affichage amélioré
 ********************************************/

//
// --- Activation du menu Infos ---
//
#define LCD_INFO_MENU                   // Active le menu "Infos" sur l'écran LCD

//
// --- Jeux Marlin (dans Infos → Marlin Games) ---
//
#define MARLIN_BRICKOUT_GAME            // Jeu de casse-briques 🧱
//#define MARLIN_INVADERS_GAME            // Jeu Space Invaders 👾
//#define MARLIN_SNAKE_GAME               // Jeu Snake 🐍
//#define MARLIN_MAZE_GAME                // Jeu du labyrinthe 🌀

//
// --- Améliorations d'affichage ---
//
#define STATUS_MESSAGE_SCROLLING        // Fait défiler les messages longs sur LCD
#define ICONS_PREVIEW_MENU              // Ajoute des icônes dans le menu principal
#define SHOW_REMAINING_TIME             // Affiche le temps restant d'impression
#define STATUS_HOTEND_ANIM              // Petite flamme animée quand la buse chauffe
#define BOOT_MARLIN_LOGO_ANIMATED    // Animation du logo Marlin au démarrage
#define STATUS_BED_ANIM              // Animation du lit chauffant
#define STATUS_FAN_ANIM              // Ventilateur animé quand il tourne
//
// --- Esthétique et style ---
//
#define LCD_INFO_SCREEN_STYLE 0         // Style par défaut pour écran 12864 (ne pas mettre 1)
#define SHOW_BOOTSCREEN                 // Affiche le logo Marlin au démarrage
#define SHOW_CUSTOM_BOOTSCREEN          // Affiche ton logo personnalisé
#define CUSTOM_BOOTSCREEN_IMAGE         // Indique qu'un logo custom est utilisé
